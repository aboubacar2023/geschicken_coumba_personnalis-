<div>
    <div class="cote-menu">
        ...
        <div class="contenu">
            <div>
              <button type="button" class="btn" style="background-color: #821435; color: white;" data-bs-toggle="modal" data-bs-target="#nouveauModal" data-bs-whatever="@mdo" ><i class="fa-solid fa-user-plus icon"></i>Nouveau Client</button>
            </div>
            <h2>LES CLIENTS</h2>
                            ...
                            @foreach ($clients as $client)
                                <tr wire:key="{{$client->id}}">
                                    ...
                                    <td>
                                        ...
                                        @endif
                                        <button type="submit" class="btn" style="background-color: #821435; color: white;"><a href="{{route('client.individuel', ['id_client' => $client->id])}}"><i class="fa-solid fa-eye"></i></a></button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
